# OJT E-Portfolio — Portodo & Oliver
...
Pure HTML, CSS, and vanilla JavaScript. No frameworks, no build step. The entire site is in `index.html` (with a duplicate copy at `portfolio.html`).
...
This repo is deployed to Vercel as a static site. Pushing to `main` triggers an automatic redeploy.
